...
'''
def plot_ABI(f_num, sat_name, TC, im_crop=[15, -105, 15], im_size=10, no_crop=False, cmap_name_list=['wv_nrl']
    ...
    if do_ADT:
        ...
        if Eye_area_r > 0:
            ...
            if find_center:
                ...
                elif image_datetime_object.minute % 15 == 0:
    ...
    # draw image
    if make_image and (not plot_all_TC_images or image_datetime_object.minute in [0, 30]):
